...
Developed features to add movies to favourites and remove them from favourites.
Saved the favourites to the local storage so that they appear when the app refreshes.
